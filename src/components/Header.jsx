    ...
    return (
        <div className="text-center d-flex flex-column align-items-center justify-content-center py-5 px-3" style={{minHeight: '80vh'}}>
            ...
            <p className="text-muted fs-5 mb-4" style={{maxWidth:"500px"}}>
                Let's start with a quick tour of the product. This will help you understand the key features and functionalities we offer.
            </p>

            <button className="btn btn-outline-dark rounded-pill px-2 py-2">
                Get Started
            </button>
        </div>
    )
